<html>
 ...
 <body>    
    ...
    <div class="col-md-8 mx-auto">
        <form method="post" action="/conference/edit">
            <input type="hidden" id="id" name="id" value="<?php echo $data['id'] ?>" />
            <p>Title: <input type="text" id="title" name="title" 
            value="<?php echo $data['title'] ?>"/></p>
            <p>Date: <input type="date" id="date" name="date"  
            value="<?php echo date('Y-m-d',strtotime($data['date'])); ?>"/></p>
            <p>Address latitude: 
                <input type="text" id="latitude" name="latitude" oninput="placeMarker()"
                value="<?php 
                //$str_latitude = strval($data['ST_X(address)']);
                echo $data['ST_X(address)']; 
                ?>"/>
            </p>
            <p>Address longtitude: 
                <input type="text" id="longtitude" name="longtitude" oninput="placeMarker()" 
                value="<?php 
                //$str_longtitude = strval($data['ST_Y(address)']);
                echo $data['ST_Y(address)'];
                ?>"/>
            </p>
            ...
            <div style="width:300px;">
                ...
                value="<?php echo $data['country'] ?>">
                    <option value="<?php  echo $data['country'] ?>" selected hidden>
                    <?php echo $data['country'] ?></option>
